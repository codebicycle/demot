...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 13, 2016 at 10:14 AM
...
(31, '340ddc288e7f2247616b43b416836fa7', '2016-08-10', '00:00:13', 'neculaies', 'necu', '1910729374220', '3a8b28efa141133cf10ffe10436b27d0', '', '', '', NULL, 'pending', '3fdb1b0d3e6bb8114f9c59ed07c12e86', NULL),
...
(43, '340ddc288e7f2247616b43b416836fa7', '2016-05-18', '12:00:00', '', '', '', NULL, '', '', '', NULL, 'approved', '3fdb1b0d3e6bb8114f9c59ed07c12e86', '61b85da718e7e4f4a89fde1af1e239ae'),
...
(46, '340ddc288e7f2247616b43b416836fa7', '2016-05-18', '14:00:00', '', '', '', NULL, '', '', '', NULL, 'pending', '3fdb1b0d3e6bb8114f9c59ed07c12e86', NULL);
...
(2, '340ddc288e7f2247616b43b416836fa7', 'uploadimg/2016-05-12.10.48.08teren.jpg');
...
('3fdb1b0d3e6bb8114f9c59ed07c12e86', 5);
...
('340ddc288e7f2247616b43b416836fa7', 'visitor', 'visitor', '1910729374510', 'visitor', '202cb962ac59075b964b07152d234b70', 'a@a.com'),
...
-- Events
--
DROP EVENT `remainingvisits_update`$$
CREATE DEFINER=`demot`@`%` EVENT `remainingvisits_update` ON SCHEDULE EVERY 1 MONTH STARTS '2016-04-13 13:11:10' ON COMPLETION NOT PRESERVE ENABLE DO UPDATE `remainingvisits` SET `RemainingVisits`= RemainingVisits + 5$$
