<?php $cache = $cache ?? null; ?>

<form action="<?php echo $form_action; ?>" method="POST" id="demot-form" novalidate >
    <?php if (isset($cache['Id']) || isset($_POST['Id'])) { ?>
    ...
    <input type="submit" name="<?php echo $form_submit; ?>" value="<?php echo $form_submit; ?>" />
</form>