...
<div class="container">
  ...
  <form action="<?php echo URL; ?>inmates/create" method="POST" id="inmates-add-form">
    ...
    <?php validation_hint($validation_errors['ReleaseDate'] ?? null) ?>
    ...
    <?php validation_hint($validation_errors['LawyerFirstName'] ?? null) ?>
    ...
    <?php validation_hint($validation_errors['LawyerLastName'] ?? null) ?>
    ...
    <?php validation_hint($validation_errors['LawyerCNP'] ?? null) ?>
